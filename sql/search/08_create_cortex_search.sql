-- ============================================================================
-- Mountain America Credit Union - Cortex Search Service Setup
-- ============================================================================
-- Purpose: Create Cortex Search services for credit union unstructured data:
...
CREATE OR REPLACE CORTEX SEARCH SERVICE SUPPORT_TRANSCRIPTS_SEARCH
  ON transcript_text
  ATTRIBUTES member_id, agent_id, interaction_type, category, subcategory
  WAREHOUSE = MACU_WH
  TARGET_LAG = '1 HOUR'
  AS SELECT
      transcript_id,
...
SELECT PARSE_JSON(
  SNOWFLAKE.CORTEX.SEARCH_PREVIEW(
      ...
      '{
          "query": "card lost travel replacement",
...
SELECT PARSE_JSON(
  SNOWFLAKE.CORTEX.SEARCH_PREVIEW(
      ...
      '{
          "query": "anti-money laundering suspicious activity reporting",
...
SELECT PARSE_JSON(
  SNOWFLAKE.CORTEX.SEARCH_PREVIEW(
      ...
      '{
          "query": "auto loan rate terms application",
